...
<button class="open-button" onclick="openForm()">click here for Login</button>
...
<div class="form-popup" id="myForm">
  ...
  <span style="color:red">@error('password') {{$message}}@enderror</span><br>
    ...
    <button type="submit" value="Submit" class="btn">Login</button>  <button type="button" class="btn cancel" onclick="closeForm()">Close</button>
  </form>
</div>
